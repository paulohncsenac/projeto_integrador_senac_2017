			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-1 col-xs-18 col-md-offset-16">
							<article data-name="gases-nobres" data-target="#<?php echo $rowElemento['id_elemento']; ?>" class="gases-nobres "><small class="numero"><?php  echo  $rowElemento['numero']; ?></small><br><b class="principal"><?php  echo  $rowElemento['label']; ?></b><br><small class="nome"><?php  echo  $rowElemento['nome']; ?></small></article>
					</div>
				...
				<?php 
					...
					<?php
		                             ...
		                             $sqlElementos = " SELECT * FROM `elementos` WHERE `elementos`.`id_elemento` >= 3  AND  `elementos`.`id_elemento` = 8 ";
					...
					?>
						...
						<article data-name="semi-metais" class="semi-metais"><small class="numero"><?php  echo  $rowElemento['numero']; ?></small><br><b class="principal"><?php  echo  $rowElemento['label']; ?></b><br><small class="nome"><?php  echo  $rowElemento['nome']; ?></small></article>
